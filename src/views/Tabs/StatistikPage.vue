  ...
  <app-layout>
    ...
    <template #content>
      ...
      <ion-card>
        ...
        <ion-card-content>
          <ion-item>
            ...
            >
              <ion-select-option value="3" selected>3 hari terakhir</ion-select-option>
      ...
      <ion-card>
        ...
        <ion-card-content>
          <ion-list v-if="transaksis.length">
            <list-riwayat
          ...
          <p v-else class="ion-text-center ion-margin-vertical">Belum ada riwayat</p>
        </ion-card-content>
      </ion-card>
    </template>
  </app-layout>
...
const loadStatistik = async () => {
  ...
  transaksis.value = data.transaksis;

  for (const tanggal in data.chart) {
    const transaksi = data.chart[tanggal];
    total.push(transaksi.total);
    jumlah.push(transaksi.jumlah);
  }
